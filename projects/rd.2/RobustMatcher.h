...
// ros: read this carefully. Add Kalmann filter
// https://docs.opencv.org/3.3.0/dc/d2c/tutorial_real_time_pose.html#gsc.tab=0
...
public:
  RobustMatcher() : ratio_(0.8f)
  {
    // ORB is the default feature
      detector_ = cv::BRISK::create();//cv::ORB::create();
      extractor_ = cv::BRISK::create();//cv::ORB::create();
